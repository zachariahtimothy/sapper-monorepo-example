...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			t6 = text("Try editing this file (routes/index.svelte) to test live reloading.");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t6 = claim_text(strong_nodes, "Try editing this file (routes/index.svelte) to test live reloading.");
